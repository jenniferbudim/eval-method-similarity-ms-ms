...
python3 train_presampled.py --train_path $DATA_DIR"/processed/data/ALL_GNPS_positive_train_split.pickle" \
                            ...
                            --presampled_train_data_dir $DATA_DIR"/raw/prebatched_data/train_unfiltered_biased.hdf5" \
                            --presampled_val_data_dir $DATA_DIR"/raw/prebatched_data/val_unfiltered_biased.hdf5" \
